...
Optitons:
    ...
    -lc=<name>      Leak Check - Check memory leaks (default = gcc/g++ -fsanitize=address)
...
COMPILATION_CPP = 'g++'
COMPILATION_CPP_STANDARD = '-std=c++17'
COMPILATIONS = {SOURCE_EXTENSIONS[0]: (COMPILATION_C, COMPILATION_C_STANDARD), SOURCE_EXTENSIONS[1]: (COMPILATION_CPP, COMPILATION_CPP_STANDARD)}
